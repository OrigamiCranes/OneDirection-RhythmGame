...
draw_text_outline_transformed(x_pos+(combo_width/2),y_pos+(combo_height/4),"Combo:",3,c_black,8,0.5,0.5);
draw_text_outline_transformed(x_pos+(combo_width/2),y_pos+((combo_height*3)/4),combo_current,3,c_black,8,0.5,0.5);
